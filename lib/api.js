...
const SCHEMA_OPTIONS = new Set([
  'after', 'before', 'function', 'in', 'middleware', 'out', 'query', 'rateLimit', 'successMsg'
])
...
const api = {
  ...
  _addRoute: function (method, route, schemaName) {
    ...
    // Resolved before the route is counted, like the schema: a broken rate
    // limit drops the route (404) at startup rather than shipping it unlimited
